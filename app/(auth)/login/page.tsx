        ...
        <div className="bg-white/[0.03] backdrop-blur-[50px] rounded-[3rem] border border-white/10 p-8 shadow-2xl overflow-hidden relative">
          ...
          <div className="space-y-6">
            <div className="space-y-4">
              <div className="group">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-4 mb-2 block transition-colors group-focus-within:text-purple-400">Email Address</label>
                <div className="relative">
                    <MdEmail className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-purple-400 transition-colors" size={18} />
                    <input
                      type="email"
                      placeholder="calm@mind.com"
                      value={email}
                      onChange={(e) => setEmail(e.target.value)}
                      className="w-full bg-black/40 text-white placeholder-gray-700 pl-12 pr-6 py-4 rounded-2xl border border-white/5 outline-none focus:border-purple-500/50 focus:bg-black/60 transition-all font-medium text-sm"
                    />
                </div>
              </div>

              <div className="group">
                <label className="text-[10px] font-black uppercase tracking-widest text-gray-500 ml-4 mb-2 block transition-colors group-focus-within:text-purple-400">Password</label>
                <div className="relative">
                    <MdLock className="absolute left-5 top-1/2 -translate-y-1/2 text-gray-500 group-focus-within:text-purple-400 transition-colors" size={18} />
                    <input
                      type="password"
                      placeholder="••••••••"
                      value={password}
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="w-full py-4 rounded-2xl bg-gradient-to-r from-pink-500 via-purple-600 to-pink-500 bg-[length:200%_auto] hover:bg-right transition-all duration-700 text-white font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-purple-500/20 disabled:opacity-50"
            >
            ...
            <div className="flex items-center justify-center gap-4 text-sm mt-6">
                <p className="text-gray-500 font-medium">New to the sanctuary?</p>
                <button 
